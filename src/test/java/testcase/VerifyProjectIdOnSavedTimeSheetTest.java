...
public class VerifyProjectIdOnSavedTimeSheetTest extends ExtentReportClass {
    ...
    public void testVerifyProjectNameOnSavedTimeSheet() throws InterruptedException {
        String screenShotPath = "",expectedProjectId="Project Name", actualProjectId="";
        Boolean flag=false;
        try {
            ...
            if (driver.getTitle().contains("Time Keeper")) {
                ...
                if (objLogin.getTextMyTimeMenu().equalsIgnoreCase("My Time")) {
                    ...
                    actualProjectId = objLogin.getProjectIdforSavedTimeSheet();
                    logger.log(LogStatus.INFO, "Project Name: " + actualProjectId);
