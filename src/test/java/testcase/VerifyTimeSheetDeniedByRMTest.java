...
public class VerifyTimeSheetDeniedByRMTest extends ExtentReportClass {
    ...
    public void testVerifyTimeSheetDeniedByRM() {
        String screenShotPath = "",expectedProjectStatus="Project Status", actualProjectStatus="";
        Boolean flag=false;
        try {
            ...
            if (driver.getTitle().contains("Time Keeper")) {
                ...
                if (objLogin.getTextMyTimeMenu().equalsIgnoreCase("My Time")) {
                    ...
                    actualProjectStatus = objLogin.getTimeSheetStatusDeniedByRM();
                    logger.log(LogStatus.INFO, "Project Id: " + actualProjectStatus);
                    if(actualProjectStatus.contains(expectedProjectStatus)){
                        flag=true;
                    }
